...
//import reactApp from "../../asset/reactapp.mp4";
//import wordPress from "../../asset/wordpress.mp4";
import PageTitle from "../../typography/PageTitle";
import Image01 from "../../asset/img1.png";
import Image02 from "../../asset/img2.png";
import Image03 from "../../asset/img3.png";
        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="grid gap-20">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              {/* Content */}
              <div className="max-w-xl text-text text-lg md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter mb-2">
                    School Website using React js
                  </div>
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      <svg
                        className="w-3 h-3 fill-current text-text mr-2 shrink-0"
                        viewBox="0 0 12 12"
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              {/* Content */}
              <div
                className="max-w-xl text-text md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6"
                data-aos="fade-left"
              >
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  <div className="font-architects-daughter text-xl text-purple-600 mb-2">
                    React Functionality page
                  </div>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-purple-600 mb-2">
                    RACING GAME UI/UX DESIGN
                  </div>
                  <h3 className="h3 mb-3">Adobe Xd</h3>
                  <p className="text-xl text-gray-400 mb-4">
                    Adobe xd is a ui design app that gives a prototype of your
                    product.
                  </p>
                  <ul className=" -mb-2">
                    <li className="flex items-center mb-2">
