...
export default function Testimonials() {
  return (
    <section>
      <div className="max-w-6xl text-text mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          {/* Testimonials */}
          <div className="max-w-sm mx-auto text-text grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            {/* 1st testimonial */}
            <div className="flex flex-col h-full p-6 " data-aos="fade-up">
              <div>
                <div className="relative inline-flex flex-col mb-4">
                  ...
                  />
                  <svg
                    className="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current "
                    viewBox="0 0 24 20"
